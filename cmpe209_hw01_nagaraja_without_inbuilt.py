...
# encrypt message with the key given
def encrypt(Input, password, outputfile):
...
def main():
    ...
    if "-e" in sys.argv:
        ...
        encrypt(input_file, key, output_file)
        print "Encryption complete."
    elif "-d" in sys.argv:
        print "Decrypting file:", input_file
        decrypt(input_file, key, output_file)
